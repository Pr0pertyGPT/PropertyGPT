...
precondition{
(amount0Out > 0 || amount1Out > 0) ? 1 : 0;
(amount0Out < reserve0 && amount1Out < reserve1) ? 1 : 0;
}

postcondition{
(balance0.mul(10000).sub(amount0In.mul(15))).mul(balance1.mul(10000).sub(amount1In.mul(15)) >= uint(reserve0).mul(reserve1).mul(1000**2)) ? 1 : 0;
}
}