...
postcondition{
    ...
    (__old__(IERC20(token0).balanceOf(address(this))) > IERC20(token0).balanceOf(address(this))) && 
    (__old__(IERC20(token1).balanceOf(address(this))) > IERC20(token1).balanceOf(address(this))) : true
}
}