...
rule LiquidityConservationCheck() {
    uint256 $baseAmount;
    uint256 $quoteAmount;
    address $caller;
    ...
    uint256 callerLiquidityBefore = liquidityBalance[$caller];
    ...
    assert(liquidityBalance[$caller] == callerLiquidityBefore + expectedLiquidityIssued);
}}